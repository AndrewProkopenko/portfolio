                ...
                props.data.map( (item, index) => ( 
                    <div className='col-12 col-sm-6 col-md-4 col-lg-3 '  key={index}>
                        <div className={`item `} style={{ backgroundImage: "url(" + item.img + ")" }}>
                            <div className={`item-${props.tabClassName} `} style={{ backgroundImage: "url(" + item.imgWrap + ")" }} ></div>
                            {
                                item.title && 
                                <h5>
                                    {item.title}
                            ...
                            <div classname='links'>
                                    {
                                        item.url &&
                                        <a href={item.url} className={`link link-url link-${props.tabClassName} `}  target='_blank' rel='noopener noreferrer' > 
